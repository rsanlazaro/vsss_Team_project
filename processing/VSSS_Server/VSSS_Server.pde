...
void ClientsTCP(){
  ...
  while(true){
    ...
    s.write("s" + "Ball:" + " " + nf(ballClass.centroidG.x,0,2) + " " + nf(ballClass.centroidG.y,0,2) + " " + "Goalkeeper:" + " " + nf(robotClass1.centroidG.x,0,2) + " " + nf(robotClass1.centroidG.y,0,2) + " " + nf(robotClass1.angle,0,2) + " " + "Midfielder:" + " " + nf(robotClass2.centroidG.x,0,2) + " " + nf(robotClass2.centroidG.y,0,2) + " " + nf(robotClass2.angle,0,2) + " " + "Striker:" + nf(robotClass3.centroidG.x,0,2) + " " + nf(robotClass3.centroidG.y,0,2) + " " + nf(robotClass3.angle,0,2) + "\n\0");
    //s.write("Hello Python: " + nf(ballClass.centroidG.x,0,2));
    delay(5);
  }
}
